									...
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											...
											<select id="city" name="city" class="form-control">
												...
												<option value="amaravati" <?php if ($row['city']=='amaravati'){echo "selected";}?>>amaravati</option>
												...
												<option value="lakhnow" <?php if ($row['city']=='Lakhnow'){echo "selected";}?>>Lakhnow</option>
												<option value="kashi" <?php if ($row['city']=='Kashi'){echo "selected";}?>>Kashi</option>
											</select>
										</div>
										<div class="form-group col-md-3">
